...
const URL = `https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=7e045adca7ae490d991373679b7977c3`;
        ...
        <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
          <div className="flex flex-col justify-between col-span-12 py-2 space-y-8 md:space-y-16 md:col-span-3">
            <div className="flex flex-col space-y-8 md:space-y-12">
              <div className="flex flex-col space-y-2">
                <h3 className="flex items-center space-x-2 dark:text-gray-600">
                  <span className="flex-shrink-0 w-2 h-2 uppercase rounded-full dark:bg-pink-300"></span>
                ...
                <p className="text-xs dark:text-gray-600">
                  ...
                  {itemContent.slice(6, 7).map((contentData) => (
                    <a
                      href={contentData.url}
                      className="hover:underline dark:text-pink-300"
                    >
                      View Details
                    </a>
                  ))}
            ...
            <div className="flex flex-col w-full space-y-2">
              <div className="flex w-full bg-opacity-10 dark:bg-pink-300">
                <div className="w-1/2 h-full dark:bg-pink-300"></div>
              </div>
              <a href="#" className="flex items-center justify-between w-full">
                ...
                <svg
                  ...
                  className="w-4 stroke-current dark:text-pink-300"
                >
          ...
          <div className="relative flex col-span-12 dark:bg-gray-500 bg-center bg-no-repeat bg-cover xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-96">
            <span className="absolute px-1 pb-2 text-xs font-extrabold uppercase border-b-2 left-6 top-6 dark:text-gray-800 dark:border-pink-300">
              Headline
            </span>
            <a
              href="#"
              className="flex flex-col items-center justify-end p-6 text-center sm:p-8 group dark:via- flex-grow-1 bg-gradient-to-b dark:from-gray-50 dark:to-gray-50"
            >
              <span className="flex items-center mb-4 space-x-2 dark:text-pink-300">
                <span className="relative flex-shrink-0 w-2 h-2 rounded-full dark:bg-pink-300">
          ...
          <div className="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
            <div className="mb-8 space-x-5 border-b-2 border-opacity-10 dark:border-pink-300">
              <button
                type="button"
                className="pb-5 text-xs font-bold uppercase border-b-2 hover:dark:border-pink-500"
              >
                Latest Updates
              </button>
            </div>
                ...
                <div className="flex flex-col flex-grow">
                  ...
                  <p className="mt-auto text-xs dark:text-gray-600">
                    ...
                    {itemContent.slice(11, 12).map((contentData) => (
                      <a
                        href={contentData.url}
                        className="block dark:text-pink-300 lg:ml-2 lg:inline hover:underline"
                      >
                        Read More
                      </a>
                    ))}
