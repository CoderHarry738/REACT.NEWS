...
function HeroSection() {
  ...
  return (
    <>
      <div className="max-w-screen-xl dark:bg-gray-100 dark:text-gray-800">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 md:gap-0 lg:grid-rows-2">
          {item.slice(0, 1).map((items) => (
            <div className="relative flex items-end justify-start w-full text-left dark:bg-gray-500 bg-center bg-cover cursor-pointer h-96 md:col-span-2 lg:row-span-2 lg:h-full group">
              <div
                className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-b dark:via- dark:from-gray-50 dark:to-gray-50"
              ...
              <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
                <a
                  rel="REPORT"
                  href="#"
                  className="px-3 py-2 text-xs font-semibold tracking-wide uppercase hover:underline dark:text-white dark:bg-pink-300"
                >
                  {items.author}
                </a>
            ...
            <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
              {item.slice(1, 2).map((items) => (
                <a
                  rel="REPORT"
                  href="#"
                  className="px-3 py-2 text-xs font-semibold tracking-wider uppercase hover:underline dark:text-white dark:bg-pink-300"
                >
                  {items.author}
                </a>
              ))}
            ...
            <h2 className="z-10 p-5">
              {item.slice(1, 2).map((items) => (
                <a
                  rel="NEWS"
                  href={items.url}
                  className="font-medium text-md group- hover:underline dark:text-gray-800"
                >
                  {items.title}
                </a>
              ))}
          ...
          <div className="relative flex items-end justify-start w-full text-left dark:bg-gray-500 bg-center bg-cover cursor-pointer h-96 group">
            ...
            <div className="absolute top-0 left-0 right-0 flex items-center justify-between mx-5 mt-3">
              ...
              <div className="flex flex-col justify-start text-center dark:text-gray-800">
                ...
                <span className="leading-none uppercase">Sept</span>
              </div>
            </div>
            <h2 className="z-10 p-5">
              {item.slice(2, 3).map((items) => (
